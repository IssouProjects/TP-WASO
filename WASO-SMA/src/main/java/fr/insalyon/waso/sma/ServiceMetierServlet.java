    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("getListeClient".equals(sma)) {
                ...
                service.RechercherClientNumero(numero);

            } else if ("rechercherClientParDenomination".equals(sma)) {
                String denomParametre= request.getParameter("denom");
                String villeParametre= request.getParameter("ville");
                
                if(denomParametre == null || villeParametre == null)
                {
                    throw new ServiceException("Paramètres incomplets");
                }
                
                service.RechercherClientDenom(denomParametre, villeParametre);
